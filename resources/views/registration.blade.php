...
<div class="container">
    ...
    <form class="dlya-galochki" method="post" action="{{('register_process')}}">
        @csrf
        <div>
        ...
        <div class="dws-input">
            <label>
                <input id ="pass2" type="password" name="password_confirmation" placeholder="Enter password">
            </label>
        </div>
        <div><button type="submit" name="sendMe" class="btn_1 btn-dark" value="1">Enter</button></div>
    </form>
</div>
</body>
</html>
