...
<div class="courses">
    <a href="{{ route('reading') }}" class="course reading" key="feedback">UP-READING</a>
    <a class="course sport" href="{{ route('sport') }}" key="feedback">UP-SPORT</a>
    <a class="course notes" href="{{ route('todo') }}" key="feedback">UP-NOTES</a>
</div>
